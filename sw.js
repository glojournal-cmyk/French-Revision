const CACHE='french-revision-paris-notebook-v1-20260902';
const ASSETS=['./','./index.html','./app.js','./question-bank.js','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
